...
<body>
                ...
                <div class="card-body">
                    <form action="ControllerBienes" method="post" onsubmit="guardar.disabled = true; return true;">
                        ...
                        <div class="form-group" align="center" style="display:none" id="botones">
                            ...
                            <button name="guardar" id="guardar" name="registrar" value="bien"  class="btn btn-primary">Guardar</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <footer class="site-footer">
        <div class="container" align="center">
            <div class="row pt-2 mt-2 text-center">
                ...
                <div class="col-md-12">
                    <strong>Coordinación General de Modernización Administrativa e Innovaci?n Gubernamental</strong>
                </div>
   ...
   var campos = ['Odescripcion', 'marc', 'model', 'numSerie', 'numInventario', 'fechaF',
       'fechaI', 'ubica', 'respon', 'depend', 'departame', 'ubicObser', 'areaO', 'estado', 'archivo', 'botones'];
            ...
            function impresoras(accion) {
                var campos = ['marc', 'model', 'numSerie', 'numInventario', 'ubica', 'respon','estado', 'toner', 'archivo', 'botones'];
                for (var i = 0; i < campos.length; i++) {
                    document.getElementById(campos[i]).style.display = accion;
                }
            ...
            function extintor(accion) {
                var campos = ['Odescripcion', 'marc', 'model', 'numInventario', 'respon', 'ubica', 'archivo', 'botones','estado'];
                var camposRequiered = ['serie', 'fechaFactura', 'fechaAltaSistema', 'dependencia', 'departamento', 'ubicacionObservacion', 'area'];
     ...
     function camposDesactivadosPosiblemente() {
                var camposRe = ["objetoDescripcion","marca","modelo","serie","inventario","fechaFactura","fechaAltaSistema","ubicacionTxt","responsable","dependencia","departamento","ubicacionObservacion","status", "tonner"];
