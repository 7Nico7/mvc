    ...
    <footer class="site-footer">
        <div class="container" align="center">
            <div class="row pt-2 mt-2 text-center">
                ...
                <div class="col-md-12">
                    <strong>Coordinación General de Modernizaci?n Administrativa e Innovaci?n Gubernamental</strong>
                </div>
    ...
    <script>
        ...
        function cambiarForm() {
            ...
            function impresoras(accion) {
                var campos = ['marc', 'model', 'numSerie', 'numInventario', 'ubica', 'respon','estado', 'toner', 'fechaM', 'archivo', 'botones'];
                for (var i = 0; i < campos.length; i++) {
                    document.getElementById(campos[i]).style.display = accion;
                }
            ...
            function extintor(accion) {
                var campos = ['Odescripcion', 'marc', 'model', 'numInventario', 'respon', 'ubica', 'fechaM', 'archivo', 'botones','estado'];
