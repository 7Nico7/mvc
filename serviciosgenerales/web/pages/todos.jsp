        ...
        $(document).ready(function () {
            $('#example').DataTable({
                ...
                columns: [
                    ...
                    {data: 'marca'},
                    {data: 'modelo'},
                    {defaultContent: "<button class='btn btn-sm btn-info btnEditar'>Editar</button>\n\
                    <button class='btn btn-sm btn-primary'>Borrar</button>\n\
                    <button class='btn btn-sm btn-success'>Evidencia</button>"},
                    {data: 'responsable'},
                    {data: 'status'},
                    {data: 'serie'}
                ]
 ...
 */
   ...
   $(document).on("click", ".btnEditar", function(){	        
    ...
    cve_bien = fila.find("td:eq(0)").text(); //capturo el ID		            
    bien = $(this).find('td:eq(1)').text();
    alert(cve_bien);
    
    console.log(cve_bien);
