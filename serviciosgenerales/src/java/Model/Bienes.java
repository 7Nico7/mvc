...
public class Bienes {
    ...
    private String cve_climas; 
    private String cve_impresoras;
    private String cve_extintores;
    ...
    private String condesador;
    private String evaporador;
    private String num_seri_cond;
    private String num_seri_evap;
    ...
    public String getCve_climas() {
        return cve_climas;
    }

    public void setCve_climas(String cve_climas) {
        this.cve_climas = cve_climas;
    }

    public String getCve_impresoras() {
        return cve_impresoras;
    }

    public void setCve_impresoras(String cve_impresoras) {
        this.cve_impresoras = cve_impresoras;
    }

    public String getCve_extintores() {
        return cve_extintores;
    }

    public void setCve_extintores(String cve_extintores) {
        this.cve_extintores = cve_extintores;
    }
    ...
    public String getCondesador() {
        return condesador;
    }

    public void setCondesador(String condesador) {
        this.condesador = condesador;
    }
    ...
    public String getNum_seri_cond() {
        return num_seri_cond;
    }

    public void setNum_seri_cond(String num_seri_cond) {
        this.num_seri_cond = num_seri_cond;
    }

    public String getNum_seri_evap() {
        return num_seri_evap;
    }

    public void setNum_seri_evap(String num_seri_evap) {
        this.num_seri_evap = num_seri_evap;
    }
