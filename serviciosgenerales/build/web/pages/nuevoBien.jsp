                ...
                <div class="card-body">
                    <form action="ControllerBienes" method="POST">
                        ...
                        <div class="form-group" align="center">
                            <input type="button" name="Regresar" value="Regresar" onClick="location.href = 'ControllerBienes?selecciono=todos'" class="btn btn-dark">
                            <button name="registrar" value="Guardar"  class="btn btn-primary">Guardar</button>
                        </div>
